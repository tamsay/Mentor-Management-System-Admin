...
const Programs = () => {
  return (
    <div>
      Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse dolorum accusamus assumenda ratione sunt labore
      accusantium porro repudiandae ducimus sequi deserunt non optio dolor reprehenderit quisquam, expedita deleniti
      facilis suscipit.
    </div>
  );
};
