    ...
    <div className={cx(styles.discussionForumCardContainer, "flexCol")}>
      <div className={cx(styles.heading, "flexRow-space-between")}>
        <div className={cx(styles.bioDataDiv, "flexRow-align-center")}>
          <Image className={cx(styles.profileImage)} src={data?.profileImage} alt='profile-image' />
      ...
      <div className={cx(styles.footer, "flexRow-space-between")}>
        <div className={cx(styles.iconsDiv, "flexRow-align-center")}>
          <Image className={cx(styles.icon)} src={commentIcon} alt='comment-icon' />
          <Image
            ...
            alt='bookmark-icon'
          />
          <Image className={cx(styles.icon)} src={shareIcon} alt='share-icon' />
        </div>
