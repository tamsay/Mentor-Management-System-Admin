...
const initialState = {
  ...
  createBroadcastMessageLoading: false,
  getMessageDetailsLoading: false,
...
export const loadingSlice = createSlice({
  ...
  reducers: {
    ...
    //Messages
    createMessageLoading: (state, action) => {
      state.createMessageLoading = action.payload;
    },
    createBroadcastMessageLoading: (state, action) => {
      state.createBroadcastMessageLoading = action.payload;
    },
    getMessageDetailsLoading: (state, action) => {
      state.getMessageDetailsLoading = action.payload;
    },
    getAllMessagesLoading: (state, action) => {
      state.getAllMessagesLoading = action.payload;
    }
  }
});
